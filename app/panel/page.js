...
// ═══════════════════════════════════════════
const catColors = {
  Mechanics: { bg: "#00ffc822", fg: "#00ffc8", border: "#00ffc844" },
  "Chaos Theory": { bg: "#c084fc22", fg: "#c084fc", border: "#c084fc44" },
  Waves: { bg: "#6bcfff22", fg: "#6bcfff", border: "#6bcfff44" },
  Optics: { bg: "#ffd93d22", fg: "#ffd93d", border: "#ffd93d44" },
  Thermodynamics: { bg: "#ff6b6b22", fg: "#ff6b6b", border: "#ff6b6b44" },
  Electromagnetism: { bg: "#a78bfa22", fg: "#a78bfa", border: "#a78bfa44" },
  Quantum: { bg: "#34d39922", fg: "#34d399", border: "#34d39944" },
  Nuclear: { bg: "#f472b622", fg: "#f472b6", border: "#f472b644" },
  Other: { bg: "#ffffff11", fg: "#94a3b8", border: "#ffffff22" },
};
...
export default function Home() {
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      {/* NAV */}
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 28px', background: 'rgba(10,12,18,0.85)', backdropFilter: 'blur(16px)', borderBottom: '1px solid #1e293b', flexWrap: 'wrap', gap: 10 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }} onClick={() => setActiveSim(null)}>
